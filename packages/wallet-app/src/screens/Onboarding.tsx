  ...
  return (
    <div className="flex h-full flex-col px-7 pb-6 pt-10">
      <div className="flex flex-1 flex-col items-center justify-center text-center">
        <motion.span className="flex h-24 w-24 items-center justify-center" initial={{ scale: 0.7, opacity: 0, rotate: -8 }} animate={{ scale: 1, opacity: 1, rotate: 0 }} transition={{ duration: 0.6, ease }}>
          <Logo size={96} glow />
        </motion.span>
